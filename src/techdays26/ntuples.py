...
# 200 n-tuples: NTUPLE_STD_LIST_150 + 50 additional random-walk tuples
# (generated with generate_random_ntuples(200, 8, seed=123), deduplicated via merge_ntuples)
NTUPLE_STD_LIST_200: list[list[int]] = NTUPLE_STD_LIST_150 + [
    [2, 8, 13, 18, 20, 24, 25, 30],
    [8, 13, 14, 18, 19, 20, 24, 25],
    [3, 5, 8, 10, 11, 14, 15, 17],
    [0, 1, 3, 4, 5, 6, 8, 11],
    [26, 27, 31, 32, 33, 34, 37, 38],
    [26, 27, 32, 33, 34, 35, 39, 40],
    [2, 3, 4, 10, 11, 14, 15, 16],
    [22, 29, 33, 34, 35, 38, 39, 40],
    [3, 9, 12, 13, 14, 19, 20, 21],
    [18, 19, 20, 25, 27, 28, 33, 34],
    [19, 20, 21, 22, 25, 29, 30, 35],
    [1, 2, 3, 6, 8, 9, 13, 14],
    [14, 16, 17, 21, 22, 23, 28, 29],
    [19, 24, 25, 26, 30, 31, 32, 37],
    [22, 23, 27, 28, 29, 33, 34, 40],
    [19, 21, 24, 25, 26, 27, 30, 31],
    [1, 7, 8, 9, 13, 14, 15, 20],
    [14, 19, 20, 21, 25, 26, 30, 31],
    [26, 27, 30, 31, 32, 33, 36, 37],
    [8, 13, 14, 15, 18, 21, 24, 25],
    [10, 14, 15, 16, 17, 20, 21, 27],
    [26, 27, 32, 33, 34, 38, 39, 40],
    [3, 4, 5, 9, 10, 11, 15, 17],
    [12, 13, 14, 18, 19, 20, 24, 25],
    [16, 21, 22, 23, 28, 34, 40, 41],
    [1, 6, 12, 13, 18, 19, 21, 26],
    [26, 31, 32, 33, 36, 37, 38, 39],
    [21, 24, 25, 26, 27, 30, 32, 37],
    [7, 9, 13, 14, 18, 19, 20, 25],
    [18, 24, 25, 30, 31, 36, 37, 38],
    [6, 7, 12, 13, 18, 19, 24, 25],
    [2, 3, 8, 9, 10, 14, 15, 16],
    [26, 31, 32, 34, 36, 37, 38, 39],
    [3, 4, 5, 10, 16, 22, 23, 29],
    [4, 8, 9, 10, 13, 14, 15, 20],
    [6, 7, 12, 14, 18, 19, 24, 25],
    [2, 8, 9, 13, 18, 19, 24, 25],
    [7, 13, 18, 19, 21, 22, 26, 28],
    [2, 7, 12, 13, 20, 25, 27, 32],
    [9, 16, 19, 23, 26, 28, 33, 34],
    [15, 20, 21, 22, 23, 27, 28, 29],
    [15, 16, 17, 22, 23, 28, 29, 35],
    [1, 2, 3, 4, 5, 9, 11, 16],
    [0, 1, 6, 7, 8, 9, 13, 14],
    [0, 1, 6, 13, 20, 21, 27, 28],
    [3, 8, 10, 11, 14, 20, 26, 27],
    [1, 2, 3, 5, 6, 7, 10, 13],
    [25, 26, 32, 33, 34, 38, 39, 40],
    [1, 2, 6, 7, 9, 13, 14, 20],
    [7, 14, 20, 21, 25, 26, 30, 32],
]

NTUPLE_BITIDX_LIST_200 = std_to_bitidx(NTUPLE_STD_LIST_200)
